...
const CompaniesSection = () => {
  return (
    <section className="py-4 bg-white">
      <Container>
        <p
          className="text-center mb-2 fw-light"
          style={{ color: '#667085', fontSize: 'clamp(0.80rem, 1.2vw + 0.5rem, 0.9rem)' }}
        >
          Trusted By 4,000+ Companies
        </p>
        <div
          className="bg-light rounded-3 py-2 px-2 border border-light mx-auto"
            ...
            {companies.map(({ name, img }) => (
              ...
              >
                <img
                  ...
                  style={
                    name === 'Zoom'
                      ? { maxHeight: 'clamp(4px, 3vw, 36px)', maxWidth: '80%', objectFit: 'contain' }
                      : { maxHeight: 'clamp(20px, 4vw, 46px)', maxWidth: '100%', objectFit: 'contain' }
                  }
                />
              </Col>
            ))}

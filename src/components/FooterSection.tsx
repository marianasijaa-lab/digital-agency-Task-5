...
const FooterSection = () => {
  ...
  return (
    <footer className='bg-light'>
        ...
        <Row className="g-5 text-center text-md-start">
          <Col xs={12} md={3}>
            <h6
              ...
              style={{ color: '#272D38', fontSize: '1.125rem', fontWeight: 700 }}
            >
              Digital Agency
            </h6>
            <p
              className="mb-0 small"
              style={{ color: '#272D38', lineHeight: 1.7, fontWeight: 300 }}
            >
      ...
      <Container>
        <p
          className="text-center py-4 mb-0 small"
          style={{ color: '#272D38', fontWeight: 300, fontSize: 'clamp(0.80rem, 1.5vw + 0.4rem, 1rem)' }}
        >
